...
const CollisionDetector = (function() {
	try {
		...
		var _RoomInfo_: typeof RoomInfo = require('./../room_info');
	}
	catch(e) {
		var _Vector_ = Vector;
	...
	//bouncing variables
	var current_vec = new _Vector_.Vec2f(), 
		bounce_vec: VectorScope.Vector = new _Vector_.Vec2f(), dot, 
	...
	function getBounceVec(object: Object2D, color: Uint8Array, map: any, 
		out_vec: VectorScope.Vector | null) 
	{
		//vec4b ray_color;
	...
	function bounceOutOfColor(object: Object2D, color: Uint8Array, map: any, 
		out_bounce_vec: VectorScope.Vector) 
	{
		bounce_vec.set(0, 0);
	...
	function objectOverlap(map: any, in_vec: VectorScope.Vector, _radius: number) {
	...
	function paintOverlap(map: any, in_vec: VectorScope.Vector, _radius: number) {
	...
	const twoObjectsIntersect = (obj1: Object2D, obj2: Object2D) => 
		_Vector_.distanceSqrt(obj1, obj2) <= pow2(obj1.width + obj2.width);
	...
	return {//ABSTRACT CLASS INTERFACE
		...
		findRandomEmptySpot: function(map: any, _radius: number, out_vec: VectorScope.Vector) {
			find_trials = 0;
