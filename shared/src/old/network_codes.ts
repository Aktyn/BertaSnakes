...
export function notificationMsg(code: NotificationCodes) {
  switch (code) {
    ...
    case NotificationCodes.ROOM_DOES_NOT_EXISTS:
      return "Room doesn't exist"
    case NotificationCodes.BANNED_FROM_ROOM:
      return 'You were banned from this room'
    case NotificationCodes.CANNOT_JOIN_AFTER_GAME_START:
      return 'You cannot join room after game start'
  }
}
