...
var Stage = (function () {
    var current = null;
    var PopupClass = /** @class */ (function () {
        function class_1() {
            this.close_callback = undefined;
        }
        class_1.prototype.onClose = function (func) {
            this.close_callback = func;
        };
        class_1.prototype.close = function () {
            try {
                $$('.description').forEach(function (d) { return d.remove(); });
            }
            catch (e) { }
    ...
    var self = /** @class */ (function () {
        ...
        class_2.prototype.popup = function (TargetClass) {
            ...
            this.current_popup.onClose(function () { return _this.current_popup = null; });
            $$.assert(this.current_popup instanceof PopupClass, 'Popup is not a parent of PopupClass class');
            return true;
        };
        class_2.prototype.enableBackgroundEffect = function () {
            if (SETTINGS.menu_background_effect === true || SETTINGS.menu_click_effect === true)
                DustBackground.init();
        };
        class_2.prototype.onServerConnected = function () { }; //virtual
        class_2.prototype.onServerDisconnect = function () { }; //virtual
        class_2.prototype.onServerMessage = function (code) { }; //virtual
        class_2.getCurrent = function () {
            return current;
        };
        return class_2;
    }());
...
$$.load(function () {
    ...
    //@ts-ignore
    var changeStage = function (StageClass) {
        ...
        //@ts-ignore
        currentStage.onchange(function (NewStageClass) {
